    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="sin-service">
          <img src="<?php echo base_url(); ?>assets/images/promo/1.jpg" alt="promo">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="sin-service">
          <img src="<?php echo base_url(); ?>assets/images/promo/2.jpg" alt="promo">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12 d-lg-block d-md-none">
        <div class="sin-service">
          <img src="<?php echo base_url(); ?>assets/images/promo/3.jpg" alt="promo">
  ...
  <div class="container-fluid">
    ...
    <div class="row mt-65 sm-mt-40">
      <div class="col-lg-3 col-sm-6 p-0">
        <div class="single-project">
          <div class="project-thumb">
            <img src="<?php echo base_url(); ?>assets/images/projects/1.jpg" alt=""/>
          </div>
          <div class="project-desc">
            <a class="venobox" data-gall="myGallery" href="<?php echo base_url(); ?>assets/images/projects/1.jpg"><i class="ti-fullscreen"></i></a>
      ...
      <div class="col-lg-3 col-sm-6 p-0">
        <div class="single-project">
          <div class="project-thumb">
            <img src="<?php echo base_url(); ?>assets/images/projects/2.jpg" alt=""/>
          </div>
          <div class="project-desc">
            <a class="venobox" data-gall="myGallery" href="<?php echo base_url(); ?>assets/images/projects/2.jpg"><i class="ti-fullscreen"></i></a>
            <h3>Stones In Fencing Embankments</h3>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 p-0">
        <div class="single-project">
          <div class="project-thumb">
            <img src="<?php echo base_url(); ?>assets/images/projects/3.jpg" alt=""/>
          </div>
          <div class="project-desc">
            <a class="venobox" data-gall="myGallery" href="<?php echo base_url(); ?>assets/images/projects/3.jpg"><i class="ti-fullscreen"></i></a>
            <h3>Stones In Fencing Embankments</h3>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 p-0">
        <div class="single-project">
          <div class="project-thumb">
            <img src="<?php echo base_url(); ?>assets/images/projects/4.jpg" alt=""/>
          </div>
          <div class="project-desc">
            <a class="venobox" data-gall="myGallery" href="<?php echo base_url(); ?>assets/images/projects/4.jpg"><i class="ti-fullscreen"></i></a>
            <h3>Stones In Fencing Embankments</h3>
          </div>
        </div>
      </div>
...
<div class="cta-area mt-100 sm-mt-80">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-8">
        <div class="cta-text">
          <h3>Live help number <span>(88) 0111 223 445 - (99) 222 555 1111</span></h3>
  ...
  <div class="container">
    ...
    <div class="row mt-63 sm-mt-40">
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="single-blog">
          <div class="blog-thumb">
            <a href="blog-details.html"><img src="<?php echo base_url(); ?>assets/images/blog/1.jpg" alt="blog-image"></a>
          </div>
          <div class="blog-desc">
            <h3><a href="blog-details.html">Landscape Architects Network</a></h3>
            <p>Don't be distracted by criticism. Remember the only taste of success some people.</p>
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="single-blog">
          <div class="blog-thumb">
            <a href="blog-details.html"><img src="<?php echo base_url(); ?>assets/images/blog/2.jpg" alt="blog-image"></a>
          </div>
          <div class="blog-desc">
            <h3><a href="blog-details.html">Expansion of Portland Japanese</a></h3>
            <p>Don't be distracted by criticism. Remember the only taste of success some people.</p>
            <a href="blog-details.html" class="readmore">Read More</a>
          </div>
        </div>
      ...
      <div class="col-lg-4 d-lg-block col-md-6 d-md-none col-sm-12">
        <div class="single-blog">
          <div class="blog-thumb">
            <a href="blog-details.html"><img src="<?php echo base_url(); ?>assets/images/blog/3.jpg" alt="blog-image"></a>
          </div>
          <div class="blog-desc">
            <h3><a href="blog-details.html">Architects and Urban Designers</a></h3>
            <p>Don't be distracted by criticism. Remember the only taste of success some people.</p>
            <a href="blog-details.html" class="readmore">Read More</a>
          </div>
        </div>
